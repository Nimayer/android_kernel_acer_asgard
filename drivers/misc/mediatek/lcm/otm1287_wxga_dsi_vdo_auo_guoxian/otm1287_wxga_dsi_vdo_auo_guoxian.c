...
/*Neostra liudongke modify for ESD protect 20170318 start*/
	params->dsi.clk_lp_per_line_enable   = 0;//neostra taosong modify disable clock continuity 20170424.
    params->dsi.esd_check_enable = 1;
    params->dsi.customization_esd_check_enable = 1;
    params->dsi.lcm_esd_check_table[0].cmd = 0x0a;
    params->dsi.lcm_esd_check_table[0].count = 1;
    params->dsi.lcm_esd_check_table[0].para_list[0] = 0x9c; 
/*Neostra liudongke modify for ESD protect 20170318 end*/
}
...
//neostra taosong add this function, screen for esd testing ,system restart.20170424 start
...
//neostra taosong add this function, screen for esd testing ,system restart.20170424 end
