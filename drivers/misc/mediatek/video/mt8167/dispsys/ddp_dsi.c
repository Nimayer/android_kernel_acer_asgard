	...
	for (i = DSI_MODULE_BEGIN(module); i <= DSI_MODULE_END(module); i++) {
		...
		if (status.RD_RDY) {
			...
			DSI_OUTREGBIT(NULL, struct DSI_INT_STATUS_REG,
                     DSI_REG[0]->DSI_INTSTA, RD_RDY, 0);//mtk add this line,screen for esd static electricity testing ,system restart.20170424
...
{
#if 0//mtk add this line , screen for esd static electricity testing , system restart.20170424
	uint32_t i;
	/*
	*
...
#endif//mtk add this line , screen for esd static electricity testing , system restart.20170424
	return DSI_STATUS_OK;
}
